...
public class SearchActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d(TAG, "hims onCreate: SearchActivity started.");
        hideSoftKeyboard();
    ...
    private void initTextListener(){
        Log.d(TAG, "hims initTextListener: initializing");
    ...
    private void searchForMatch(String keyword){
        Log.d(TAG, "hims searchForMatch: searching for a match: " + keyword);
        mUserList.clear();
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NotNull DataSnapshot dataSnapshot) {
                    for(DataSnapshot singleSnapshot : Objects.requireNonNull(dataSnapshot).getChildren()){
                        Log.d(TAG, "hims onDataChange: found user:" + Objects.requireNonNull(singleSnapshot.getValue(User.class)).toString());
    ...
    private void updateUsersList(){
        Log.d(TAG, "hims updateUsersList: updating users list");
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Log.d(TAG, "hims onItemClick: selected user: " + mUserList.get(position).toString());
    ...
    private void setupBottomNavigationView(){
        Log.d(TAG, "hims setupBottomNavigationView: setting up BottomNavigationView in SearchActivity");

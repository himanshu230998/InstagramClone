...
public class AccountSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d(TAG, "hims onClick: navigating back to 'ProfileActivity'");
                finish();
            }
        });
    }
    ...
    private void getIncomingIntent(){
        ...
        if(intent.hasExtra(getString(R.string.selected_image))
            ...
            Log.d(TAG, "hims getIncomingIntent: New incoming imgUrl");
        ...
        if(intent.hasExtra(getString(R.string.calling_activity))){
            Log.d(TAG, "hims getIncomingIntent: received incoming intent from " + getString(R.string.profile_activity));
    ...
    public void setViewPager(int fragmentNumber){
        ...
        Log.d(TAG, "hims setViewPager: navigating to fragment #: " + fragmentNumber);
        mViewPager.setAdapter(pagerAdapter);
        mViewPager.setCurrentItem(fragmentNumber);
    }

    private void setupSettingsList(){
        Log.d(TAG, "hims setupSettingsList: initializing 'Account Settings' list.");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Log.d(TAG, "hims onItemClick: navigating to fragment#: " + position);
